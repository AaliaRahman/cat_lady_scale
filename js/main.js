...
$(document).ready(function(){
     ...
     */
     //Aalia's logic - use new keyword to use a constructor. catLadyBehaviors is an instance of Behavior constructor
    var catLadyBehaviors = [
        ...
        new Behavior("takes selfies with dogs", -4),
        new Behavior("adopt a cat", 9),
        new Behavior("advocate for cat rights", 10)
        // -----------------------------------------------------------------------------------------
        // TODO: CHALLENGE 1
    ...
    var catLady = {
        ...
        updateStatus: function () {
          var total = 5;
          for (behavior in catLadyBehaviors){
            total += behavior.pointValue;
          }
          return total;
            //--------------------------------------------------------------------------------------
            // TODO: CHALLENGE 8
    ...
    $('#add-behavior').click(function(e){
        ...
        var behavior = catLadyBehaviors[$("option[selected]").val()];
        ...
        // 4. Now add the behavior to the catLady object. (new object)
        //------------------------------------------------------------------------------------------
